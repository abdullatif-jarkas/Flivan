                    ...
                    <form method="POST" action="{{ route('passenger.update', $passenger->id) }}">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="name" value="{{ $passenger->name }}" required>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label"><i class="fa fa-hourglass-half me-2"></i>Age</label>
                                <input type="number" class="form-control" name="age" value="{{ $passenger->age }}" required>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control" name="phone" value="{{ $passenger->phone }}" required>
                            </div>
                        </div>

                        <div class="d-grid mt-4">
                            <button type="submit" class="btn btn-primary btn-lg"><i class="fa fa-save me-2"></i>Update</button>
                        </div>
                    </form>
                </div>
